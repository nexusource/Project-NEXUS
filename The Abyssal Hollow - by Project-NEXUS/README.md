...
配信、動画利用はOKです。
この作品は諸関係者の熱意と労力、各関係者の善意で成り立っています。特に竹間書房様には、作品の迷惑になる場合は即時掲載を削除する旨を連絡しています。下記の迷惑行為はやめてください。許可のない再配布と誰かを害する迷惑行為、ブランドイメージを損なう行為を禁じます。  
また、国際法、日本国法、所在地法に則り公序良俗に反する迷惑行為を禁じます。其の上で上記の規約と総合規約を遵守してください。
